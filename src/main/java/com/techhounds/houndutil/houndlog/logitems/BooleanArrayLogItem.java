...
public class BooleanArrayLogItem extends LogItem<boolean[]> {
     ...
     */
    public BooleanArrayLogItem(String key, Callable<boolean[]> func, LogLevel level) {
     ...
     * @param func the function to call to get the value
     */
    public BooleanArrayLogItem(String key, Callable<boolean[]> func) {
    ...
    public void initPublisher() {
        ...
        try {
            publisher = getDataTable().getBooleanArrayTopic(key).publish();
        } catch (Exception e) {
            e.printStackTrace();
        }
        inited = true;
