...
public class DoubleArrayLogItem extends LogItem<double[]> {
     ...
     */
    public DoubleArrayLogItem(String key, Callable<double[]> func, LogLevel level) {
     ...
     * @param func the function to call to get the value
     */
    public DoubleArrayLogItem(String key, Callable<double[]> func) {
    ...
    public void initPublisher() {
        ...
        try {
            publisher = getDataTable().getDoubleArrayTopic(key).publish();
        } catch (Exception e) {
            e.printStackTrace();
        }
        inited = true;
