...
public class BooleanLogItem extends LogItem<Boolean> {
     ...
     */
    public BooleanLogItem(String key, Callable<Boolean> func, LogLevel level) {
     ...
     * @param func the function to call to get the value
     */
    public BooleanLogItem(String key, Callable<Boolean> func) {
    ...
    public void initPublisher() {
        ...
        try {
            publisher = getDataTable().getBooleanTopic(key).publish();
        } catch (Exception e) {
            e.printStackTrace();
        }
        inited = true;
