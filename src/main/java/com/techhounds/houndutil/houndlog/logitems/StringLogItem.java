...
public class StringLogItem extends AbstractLogItem<String> {
     ...
     */
    public StringLogItem(String subsystem, String key, Supplier<String> func, LogLevel level) {
     ...
     * @param level         the level at which to place the LogItem
     */
    public StringLogItem(String key, Supplier<String> func, LogLevel level) {
