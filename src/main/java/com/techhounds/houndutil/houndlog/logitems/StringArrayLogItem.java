...
public class StringArrayLogItem extends LogItem<String[]> {
     ...
     */
    public StringArrayLogItem(String key, Callable<String[]> func, LogLevel level) {
     ...
     * @param func the function to call to get the value
     */
    public StringArrayLogItem(String key, Callable<String[]> func) {
    ...
    public void initPublisher() {
        ...
        try {
            publisher = getDataTable().getStringArrayTopic(key).publish();
        } catch (Exception e) {
            e.printStackTrace();
        }
        inited = true;
